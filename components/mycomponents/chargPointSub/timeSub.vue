	...
	<view class="picker timeSub">
		...
		<view v-if="showTimePicker" class="picker">
			<view class="picker-modal picker-time">
				<view class="picker-modal-header" v-if="!showFull">
					<text class="picker-modal-header-title">设置开始时间</text>
					<span ></span>
				</view>
				<view class="picker-modal-header" v-else>
					<text class="picker-modal-header-title">设置结束时间</text>
					<span class="full" @tap="onConfull">充满为止</span>
				</view>
				...
				<view class="picker-modal-footer">
      		<span class="add-btn" @tap="onConfirmTime">确认</span>
					<!-- <view class="picker-modal-footer-info">
						<view class="picker-display">
							<text>当前选择</text>
